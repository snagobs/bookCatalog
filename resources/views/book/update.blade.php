                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group" {{ $errors->has('price') ? 'has-error' : ''}}>
                            <label>Price</label>
                            <input class="form-control" placeholder="Price" type="number" min="1" step="0.01" name="price"
                                   value="{{ $book->price }}">
                            {!! $errors->first('price', '<small class="text-danger">:message </small>') !!}
                        </div>
                        <div class="form-group" {{ $errors->has('description') ? 'has-error' : ''}}>
                            <label>Description</label>
                            <textarea name="description" cols=1000  rows=6 placeholder="Description" class="form-control">
                                {{ $book->description }}
                            </textarea>
